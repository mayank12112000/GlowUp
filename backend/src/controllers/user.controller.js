...
const registerUser = asyncHandler(async (req,res)=>{
    ...
    if ([name, mobile, password, userName, roleSeq, email].some(field => !field)) {
    ...
    await runQuery(CREATE_USER,[userName.toLowerCase(),email,hashedPassword,name,mobile,roleSeq])
